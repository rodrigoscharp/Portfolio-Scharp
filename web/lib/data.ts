...
export const CASES: Case[] = [
  ...
  },
  {
    ...
    read: "[X] min Read",
    headline: [
      { text: "APAE Ubatuba", bold: true },
      { text: ": a management system serving " },
      { text: "[MÉTRICA] families", bold: true },
    ],
    tags: ["WEB", "GOVTECH", "SOCIAL"],
    bg: "linear-gradient(135deg,#3cb04c 0%,#14532d 100%)",
    device: "phone",
    image: "/images/apae-hero.svg",
    insights: [{ value: "[MÉTRICA]", label: "[descrição da métrica]" }],
    caseHref: "#",
    layout: "half",
    dark: false,
...
export const ROWS: Row[] = [
  ...
  { year: "2026", title: "APAE Ubatuba Management System", cta: "case", href: "#", image: "/images/apae-hero.svg" },
  ...
  { year: "2026", title: "PONTE — AAC App for Autistic Children", cta: "repo", href: "https://github.com/rodrigoscharp/PONTE", image: "/images/apae-hero.svg" },
